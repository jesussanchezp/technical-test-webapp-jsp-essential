...
public class TaskDeleteController extends HttpServlet {
  ...
  private static final Logger logger = LoggerFactory.getLogger(TaskDeleteController.class);
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    logger.info("Task {} to Delete", taskModel.getTitle());
    req.setAttribute("title", "Eliminar Tarea");
    req.setAttribute("isError", "false");
    req.setAttribute("task", taskModel);
    req.getRequestDispatcher("/WEB-INF/views/task-delete.jsp").forward(req, resp);
  }
